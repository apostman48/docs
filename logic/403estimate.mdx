---
title: 'Why do I get a 403 error when making an estimate request?'
description: 'If you're receiving a 403 Forbidden error when trying to access RESTimates (AI-Powered Property Estimates), this indicates that the RESTimates addon is not included in your current plan or has not been activated for your account.'
---
